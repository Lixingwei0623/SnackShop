<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page  import="bean.Snack" %>
    <%@ page  import="dao.impl.ISnackDaoImpl" %>
...
<%
	...
	ISnackDaoImpl iSnackDaoImpl=new ISnackDaoImpl();	
...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="list-group list-group-horizontal" style="margin-left:10%;margin-right:5%;">       
        ...
        <p class="list-group-item active" style="width:100px;">保质期</p>
        <p class="list-group-item active" style="width:90px;">单价</p>
    ...
    <c:forEach items="${snacks }" var="snack">
	    <div class="list-group list-group-horizontal" style="margin-left:10%;margin-right:5%;margin-bottom:0px;">       
	        ...
	        <p class="list-group-item " style="width:100px;">${snack.getExpirationdate() }个月</p>	     
	        <p class="list-group-item " style="width:90px;">${snack.getPrice() }</p>   
